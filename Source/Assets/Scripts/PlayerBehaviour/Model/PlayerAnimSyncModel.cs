...
namespace PlayerBehaviour.Model
{
	...
	public class PlayerAnimSyncModel : MonoBehaviour, IPunObservable
	{
		...
		private void UpdateShoulder()
		{
			...
			RightShoulderIK.localPosition = Vector3.Lerp(m_updatedShoulderPos, m_lastShoulderPos, m_fraction);
			RightShoulderIK.localRotation = Quaternion.Lerp(m_updatedShoulderRot, m_lastShoulderRot, m_fraction);
		}
